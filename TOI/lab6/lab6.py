...
plt.plot(epochs, loss_values, 'ro', label='Потери на обучающем наборе')
plt.plot(epochs, val_loss_values, 'b', label='Потери на проверочном наборе')
plt.title('Потери на обучении и проверке')
plt.xlabel('Эпохи')
plt.ylabel('Потери')
plt.legend()
plt.show()

...
class DatabaseHelper extends SQLiteOpenHelper implements BaseColumns {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + DBContract.DBEntry.TABLE_NAME
                ...
                DBContract.DBEntry.COLUMN_NAME_CITY + " TEXT);");
        ...
        values.put(DBContract.DBEntry.COLUMN_NAME_CITY, "Москва");
        ...
        values.put(DBContract.DBEntry.COLUMN_NAME_CITY, "Тула");
        db.insert(DBContract.DBEntry.TABLE_NAME, DBContract.DBEntry.COLUMN_NAME_NAME, values);
        ...
        values.put(DBContract.DBEntry.COLUMN_NAME_CITY, "Воронеж");
        db.insert(DBContract.DBEntry.TABLE_NAME, DBContract.DBEntry.COLUMN_NAME_NAME, values);
    }
    @Override
